...
public class AnimationPanel extends JComponent implements Runnable {
    ...
    public AnimationPanel() {
		shapes = new ArrayList<MovingShape>(); //create an array *list* to store shapes
	...
	public void setCurrentWidth(int w) {
		...
		for (int i=0;i<count;i++){
			if ( shapes.get(i).isSelected()){
				...
				if ((shapes.get(i) instanceof MovingSquare) || (shapes.get(i) instanceof MovingSquarePattern) || (shapes.get(i) instanceof MovingQuadPie))
					shapes.get(i).setHeight(currentWidth);
			}
		}	
	}
